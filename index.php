		...
		<div id="content" class="row">
			<div id="stream">
					...
					foreach($xml->post as $posts)
                		...
                		?>
					<div id="newpost"><textarea id="text_input" maxlength="256" cols="64" name="text_input" rows="4">Say something interesting</textarea><br><div id="counter">25/256</div><input id="text_submit" type="submit" name="submit" /></div>
			</div>
